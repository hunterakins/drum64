...
static void set_voltage(uint16_t level) { //float millivolts) {
...
int main(void) {
  ...
  //pwmEnablePeriodicNotification(&PWMD1); // this enables the drive ..?
   ...
   */
  I2CConfig i2cConfig;
  i2cConfig.ic_speed = 1000000;
  //i2cConfig.clock_speed = 400; // maximum 400 kHz?
