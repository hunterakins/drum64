...
static void interrupt_loop(GPTDriver *gptp) {
  ...
  palClearPad(ONBOARD_LED_PORT, ONBOARD_LED_PAD); // takes 1.4 us of computation time
...
int main(void) {
   ...
   */
  I2CConfig i2cConfig;
  //i2cConfig.ic_speed =    500000; // manifests as 800kHz
  i2cConfig.ic_speed = 1000000; // manifests as 1.6MHz no?
